...
public class CredendioDialect extends AbstractProcessorDialect {
	
	public CredendioDialect() {
		super("Credendio Sistemas", "credendio", StandardDialect.PROCESSOR_PRECEDENCE);
	}
